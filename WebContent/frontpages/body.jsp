...
<html>
  <head>
    ...
    <script type="text/javascript" src="/jquery/gundong.js"></script>
	<style>.top{height:35%;width:100%;padding-right: 10px}
			  *{margin:0;
				 padding:0;
				 list-style:none;}
				 .wrap{height:100%;
...
<div class="top" >
	<div class="wrap" id='wrap'>
			 <ul id="pic">
				<li><img src="/images/img1.jpg" alt="" width="1040px" height="450px"></li>
				<li><img src="/images/img2.jpg" alt="" width="1040px" height="450px"></li>
				<li><img src="/images/img3.jpg" alt="" width="1040px" height="450px"></li>
				<li><img src="/images/img4.jpg" alt="" width="1040px" height="450px"></li>
				<li><img src="/images/img5.jpg" alt="" width="1040px" height="450px"></li> 
			</ul>
				<ol id="list">
				   <li class="on">1</li>
					<li>2</li>
