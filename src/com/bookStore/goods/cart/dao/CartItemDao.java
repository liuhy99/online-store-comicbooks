...
public class CartItemDao {
	...
	private String toWhereSql(int len) {
		StringBuilder sb = new StringBuilder("cartitem.cartItemId in (");
		for (int i = 0; i < len; i++) {
			sb.append("?");
			if (i < len - 1) {
				sb.append(",");
	...
	// 用来生成where子句
	private String toWhereSql1(Object[] array) {
		StringBuilder sb = new StringBuilder("cartitem.cartItemId in (");
	...
	public List<CartItem> loadCartItems(String cartItemIds) throws SQLException {
		...
		String whereSql = toWhereSql1(cartItemIdArray);

		String sql = "select * from cartitem , book where cartitem.bid=book.bid and " + whereSql;
	...
	public void batchDelete(String cartItemIds) throws SQLException {
		...
		qr.update(sql);// 其中cartItemIdArray必须是Object类型的数组！
	}
	...
	public List<CartItem> findByUser(String uid) throws SQLException {
		String sql = "select * from cartitem , book  where cartitem.bid=book.bid and cartitem.uid=? order by cartitem.orderBy";
